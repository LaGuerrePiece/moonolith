...
function elementDrag(e) {
    ...
    if(currentPosition.x > window.innerWidth - 120)
        currentPosition.x = window.innerWidth - 120
    else if(currentPosition.x < 20)
        currentPosition.x = 20

    if(currentPosition.y > window.innerHeight - 80)
        currentPosition.y = window.innerHeight - 80
    else if(currentPosition.y < 20)
